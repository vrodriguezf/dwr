...
schema.statics.getStaticGCSs = function (callback) {
...
var collectionName = _.find(dbConf.UAS_Info.collections,{'id' : 'GCSs'}).name;
var nativeCollection = require('mongoskin').db(dbConf.UAS_Info.getURL()).collection(collectionName);
