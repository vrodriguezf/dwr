 ...
 * Compilation
 **/
var connection = baseRequire('/conf/DBConnections').get(dbConf.UAS_Configuration.defaultConnectionName);
var collectionName = _.find(dbConf.UAS_Configuration.collections,{'id' : 'ObjectiveTypes'}).name;
